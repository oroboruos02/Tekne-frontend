  ...
  let { hoverProps, triggerHoverEnd } = (0, import_react26.useMemo)(() => {
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      hoverProps2.onPointerLeave = (e7) => {
        if (!isDisabled && e7.currentTarget.contains(e7.target))
...
var observeElementOffset = (instance, cb) => {
  ...
  const createHandler = (isScrolling) => () => {
    offset3 = element[instance.options.horizontal ? "scrollLeft" : "scrollTop"];
    fallback();
      ...
      if (this.scrollElement !== scrollElement) {
        ...
        this.unsubs.push(
          this.options.observeElementOffset(this, (offset3, isScrolling) => {
            this.scrollAdjustments = 0;
            this.scrollDirection = isScrolling ? this.scrollOffset < offset3 ? "forward" : "backward" : null;
    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey }, itemSizeCache) => {
        ...
        for (let i11 = min2; i11 < count2; i11++) {
          ...
          const size3 = typeof measuredSize === "number" ? measuredSize : this.options.estimateSize(i11);
    ...
    this.getOffsetForAlignment = (toOffset, align) => {
      ...
      if (align === "auto") {
        if (toOffset <= this.scrollOffset) {
          align = "start";
        } else if (toOffset >= this.scrollOffset + size3) {
          align = "end";
        } else {
          align = "start";
        }
      ...
      if (align === "start") {
        ...
        toOffset = toOffset - size3;
      } else if (align === "center") {
        toOffset = toOffset - size3 / 2;
      }
...
function ve2({ children: e7, enabled: t15 = true }) {
  ...
  let { refs: b7, floatingStyles: $5, context: g7 } = useFloating2({ open: o17, placement: s16 === "selection" ? f21 === "center" ? "bottom" : `bottom-${f21}` : f21 === "center" ? `${s16}` : `${s16}-${f21}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: s16 === "selection" ? 0 : C7, crossAxis: M7 }), shift2({ padding: p8 }), s16 !== "selection" && flip2({ padding: p8 }), s16 === "selection" && P7 ? inner({ ...P7, padding: p8, overflowRef: c13, offset: a15, minItemsVisible: q, referenceOverflowThreshold: p8, onFallbackChange(h7) {
    var W7, k4;
    if (!h7)
      return;
  ...
  } }) : null, size2({ padding: p8, apply({ availableWidth: h7, availableHeight: d15, elements: T12 }) {
